...
void llama_example(const INIReader reader)
{
    ...
    //:wconst size_t inter_size   = 4 * hidden_units;
    const int    inter_size	      = reader.GetInteger(model_name, "inter_size");
    ...
    read_word_list("../examples/cpp/gptneox/bad_words.csv", bad_words);
    ...
    read_word_list("../examples/cpp/gptneox/stop_words.csv", stop_words);
    ...
    read_start_ids(request_batch_size,
                   ...
                   end_id,
                   1,
                   "../examples/cpp/gptneox/start_ids.csv");
